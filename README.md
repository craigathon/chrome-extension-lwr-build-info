...
When an LWR site is loaded, a UI popup will dsiplay. It allows you to add and remove a clickable badge for each component placed by builder on the live site page.
